...
public class SimpleEliminationTest
{
	public static void main(String[] args)
	{
		...
		// Remove row elimination
		solution.erase(Pair.of(4, 5));
		solution.erase(Pair.of(2, 5));
		solution.erase(Pair.of(6, 4));
		
		// Remove column elimination
		solution.erase(Pair.of(8, 3));
		solution.erase(Pair.of(7, 1));
		solution.erase(Pair.of(8, 6));
